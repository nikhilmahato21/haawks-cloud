    ...
    <section className="px-3 bg-white py-10 lg:px-20 flex flex-col items-center justify-center">
      ...
      <div className="container lg:flex  gap-24  rounded-lg p-2 py-6 ">
        ...
        <div className="max-w-3xl  flex flex-col justify-center items-center  ">
          <h2 className="font-bold mt-8 lg:mt-0 text-black mb-4 md:mb-8 text-5xl bg-clip-text  text-center  px-6 drop-shadow-2xl  bg-gradient-to-b from-white/80 to-white/90 max-w-2xl">
            About Our{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-[#4d229e]">
              Company
            </span>
          </h2>
          <p className="bg-clip-text text-black  text-center font-bold px-2  drop-shadow-2xl text-xl  max-w-2xl">
